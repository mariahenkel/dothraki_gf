concrete CatDot of Cat = CommonX - [Pol] ** open ResDot, Prelude in {
...
-- Sentence
    ...
    Cl = {s : ResDot.Tense => Anteriority => CPolarity => Order => Str} ;
    ClSlash = {
      s : ResDot.Tense => Anteriority => CPolarity => Order => Str ;
      c2 : Str
      } ;
...
-- Question
    ...
    QCl = {s : ResDot.Tense => Anteriority => CPolarity => QForm => Str} ;
...
-- Relative
    ...
    RCl = {
      s : ResDot.Tense => Anteriority => CPolarity => Agr => Str ; 
      c : NPCase
      } ;
